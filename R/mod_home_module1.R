  ...
  tagList(
    fluidRow(
      ...
      column(3, 
             ...
             bs4Dash::valueBox(value = "ASReml-R", 
             ...
             bs4Dash::valueBox(value = "Predictions", 
             ...
             bs4Card(title = "Jump",
                     ...
                     width = 12,
                     solidHeader = TRUE,
                     actionLink(inputId = ns("toAwesome1"), 
                                label = "Data",
                                icon = icon("database"),
                                style = "color: #d9534f"),
                     br(),
                     actionLink(inputId = ns("toAwesome2"),
                                label = "Spatial", 
                                icon = icon("braille"),
                                style = "color: #d9534f"),
                     br(),
                     actionLink(inputId = ns("toAwesome3"),
                                label = "Lme4", 
